...
- **Original URL:** https://partner.skills.google/paths/20/course_sessions/40490346/labs/621222
- **Lesson type:** `labs`
- **Path ID:** `20`
...
![Google Cloud Project Dashboard](assets/image_004.png)
...
![Web preview option 'Preview on port 8080'.](assets/image_007.png)

### Image 8

![App Engine Link](assets/image_008.png)

### Image 9

![Logs Link highlighted in the Diagnose menu.](assets/image_009.png)
...
```
training-data-analyst/courses/design-process/deploying-apps-to-gcp
```
