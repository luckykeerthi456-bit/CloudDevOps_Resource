# Advanced Logging and Analysis - Using log-based metrics | Google Skills for Partners

---

## Metadata

- **URL:** https://partner.skills.google/paths/20/course_sessions/40490346/html_bundles/621232
- **Lesson type:** `html_bundles`
- **Path ID:** `20`
- **Container type:** `course_sessions`
- **Container ID:** `40490346`
- **Lesson ID:** `621232`
- **Generated:** 2026-07-13 04:01:38
